...
<div class="container">
    ...
    <div class="col-md-8">
            <div class="card mb-5 mt-1">
                <div class="card-header">Marcadores</div>
                <div class="card-body">
                @foreach($categorias as $categoria)
                <a class="link-primary" href="{{ route('categoria.marcadores',['id' => $categoria->id]) }}"><span class="categoria" style="background-color: {{$categoria->color}};">{{$categoria->name}} ({{count($categoria->urls)}})</span></a>
                @endforeach
        ...
        @foreach($categorias as $categoria)
            <div class="card mb-3 mt-3">
                <div class="card-header"><span class="categoria botonCategorias" style="background-color: {{$categoria->color}};"><a class="link-primary" href="{{ route('categoria.marcadores',['id' => $categoria->id]) }}">{{$categoria->name}}</a></span></div>
                <div class="card-body">
                    <ul class="list-group">
