    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card mb-5 mt-2">
                <div class="card-header">Cambiar datos personales</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" aria-label="Cambiar datos personales">
                        @csrf
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-5 mt-2">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update.password') }}" aria-label="Cambiar contraseña">
                        @csrf
